    ...
    <div class="row university__show university_page">
        ...
        <div class="col-md-9">
            <div class="tab-content">
                <div id="general" class="tab-pane fade in active">
                    ...
                    <br> @php $true = '<i class="fa fa-check-circle" aria-hidden="true"></i>'; $false = '<i class="fa fa-times-circle" aria-hidden="true"></i>'; @endphp
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table faculties__table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <strong>Факультет русской филологии</strong> @php $slash=''; @endphp @if($faculty->full_time_learning)очная @php $slash='/'; @endphp @endif @if($faculty->non_public_learning){{$slash}}заочная @php $slash='/'; @endphp @endif @if($faculty->distance_learning){{$slash}}дистанционная@endif

                                            <strong style="margin-top: 10px;">Длительность обучения</strong> {{ $faculty->duration_learning }} @if($faculty->duration_learning == 1) год @elseif($faculty->duration_learning > 1 && $faculty->duration_learning
                                            <=4 ) года @else лет @endif <strong style="margin-top: 10px;">Экзамены для поступления</strong>
                                                @php $facultySubjects = $faculty->subjects->pluck('name')->toArray(); echo implode(', ', $facultySubjects); @endphp
                                        </td>
        ...
        <div class="col-md-3">
            <div class="vuz_page_sidebar">
                ...
                <div class="price_box">
                    От {{ priceString($university->price) }} р./год
                </div>
