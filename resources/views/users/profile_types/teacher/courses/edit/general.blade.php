...
@section('edit_form')   
	<form class="ajax__submit has--preload listener__change_form course__form_hc" method="POST" action="{{ route(userRoute('update_course_general'), ['id' => $course->id]) }}">
	    {{ csrf_field() }}
             ...
             <div class="col-md-7">
                <div class="row">
                      ...
                      <div class="form-group select_form">
                         <select name="id_category" class="form-control onload__change" onchange="loadCourseSubcats(this, {{ $course->id_subcat }})">
