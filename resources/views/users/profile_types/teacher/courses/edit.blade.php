   ...
   <div class="row">
      ...
      <div class="row">
         <ul class="nav add_course" role="tablist">
            <li role="presentation" class="{{ isActive(route(userRoute('edit_course'), ['id' => $course->id])) ? 'active' : '' }}">
            ...
            <li role="presentation" class="{{ isActive(route(userRoute('edit_course_settings'), ['id' => $course->id])) ? 'active' : '' }}">
            ...
            <li role="presentation" class="{{ isActive(route(userRoute('edit_course_program'), ['id' => $course->id])) ? 'active' : '' }}">
            ...
            <li role="presentation" class="{{ isActive(route(userRoute('course_participants'), ['id' => $course->id])) ? 'active' : '' }}">
            ...
            <li role="presentation" class="{{ isActive(route(userRoute('edit_course_сertificates'), ['id' => $course->id])) ? 'active' : '' }}">
