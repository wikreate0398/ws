        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    value="{{!empty($userUniversity->license_nr_from) ? date('d-m-Y', strtotime($userUniversity->license_nr_from)) : ''}}" placeholder="DD/MM/YY" required> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control datepicker" name="accreditation_nr_from"
                     value="{{ !empty($userUniversity->accreditation_nr_from) ? date('d-m-Y', strtotime($userUniversity->accreditation_nr_from)) : '' }}" placeholder="DD/MM/YY" required>
